...
export default function HomeImagesNav() {
  return (<div>
    <Container component="section" sx={{ mt: 8, mb: 4 }}>
      <Typography variant="OnePirateTypography-markedH4Center" marked="center" align="center" component="h2" style={{}}>
        Book your trip
        <br></br>
        For all tastes and all desires
        <span style={{height:4, width: 55,display: 'block', margin: 'auto',marginTop:'10px', backgroundColor:'#FA2F13'}}></span>
      </Typography>
